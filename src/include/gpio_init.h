...
{
  private:
  volatile unsigned char* DDRx;                    // pointer that hold the address of DDR(B,C,D) depend on pin number.
  volatile unsigned char* PORTx;                   // pointer that hold the address of PORT(B,C,D) depend on pin number.
  volatile unsigned char* PINx;                    // pointer that hold the address of PIN(B,C,D) depend on pin number.
