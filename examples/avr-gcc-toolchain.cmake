...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mmcu=atmega328p -DF_CPU=16000000UL")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++17 -mmcu=atmega328p -DF_CPU=16000000UL -fno-exceptions -fno-rtti")
